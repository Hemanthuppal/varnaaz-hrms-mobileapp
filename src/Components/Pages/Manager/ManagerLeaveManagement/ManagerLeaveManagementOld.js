...
import './ManagerLeaveManagement.css'; // Styling
...
const ManagerLeaveManagement = () => {
  ...
  return (
    ...
    <div className="leave-header">
      <button className="man-hrms-add-leave-btn" onClick={() => setShowModal(true)}>
        Add Leave
      </button>
      </div>
      <h2 className='man-hrms-h2'>Leave Records</h2>
      {showModal && (
        <div className="man-hrms-modal">
          <div className="man-hrms-modal-content">
            <span className="man-hrms-close" onClick={closeModal}>
              &times;
            </span>
            <h2>Add Leave</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div className="man-hrms-close-submit-btn">
                <button type="submit" className="man-hrms-submit-btn">
                  {loading ? 'Submitting...' : 'Submit'}
                </button>
                <button type="button" className="man-hrms-close-btn" onClick={closeModal}>
                  Close
                </button>
              </div>
            </form>
      ...
      <div className="man-hrms-leave-table">
