...
const ViewPayslips = () => {
    ...
    const [payslips, setPayslips] = useState([]); // Initialize as an empty array
        ...
        const fetchPayslipData = async () => {
            ...
            if (user) {
                ...
                if (payslipSnapshot.exists()) {
                    ...
                    // Set the initial selected month to the most recent one if exists
