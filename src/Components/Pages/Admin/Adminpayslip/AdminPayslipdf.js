...
const AdminPayslipdf = ({ selectedEmployeeId, fullName, basicsalary, epf, professionalTax, travellingAllowance, totalEarnings, totalDeductions, netSalary, lopDays, lopAmount }) => {
