...
// import { Table, Button, Card, Alert, Modal } from "react-bootstrap";
...
//     if (file) {
//       const storageRef = ref(storage, `employees/${editEmployeeData.id}/${fieldName}`);
...
//                       <td>
//                         <Button variant="primary" onClick={() => handleViewClick(employee)}>
//                           View Details
//                         </Button>
//                       </td>
//                       <td>
...
//         {/* Modal to display optional employee details */}
...
//                     <a href={selectedEmployee.resume} target="_blank" rel="noopener noreferrer">
//                       View Resume
//                     </a>
//                   </p>
//                 )}
...
//                     <a href={selectedEmployee.aadhaarCard} target="_blank" rel="noopener noreferrer">
//                       View Aadhaar Card
//                     </a>
//                   </p>
//                 )}
...
//                     <a href={selectedEmployee.panCard} target="_blank" rel="noopener noreferrer">
//                       View PAN Card
//                     </a>
//                   </p>
//                 )}
...
//                     <a href={selectedEmployee.drivingLicense} target="_blank" rel="noopener noreferrer">
...
//                     onChange={(e) => setEditEmployeeData({ ...editEmployeeData, contactNo: e.target.value })}
//                   />
//                 </div>
//                 <div className="mb-3">
//                   <label>Email</label>
...
//                     onChange={(e) => setEditEmployeeData({ ...editEmployeeData, location: e.target.value })}
//                   />
//                 </div>
//                 <div className="mb-3">
//                   <label>Skills</label>
...
//                     onChange={(e) => setEditEmployeeData({ ...editEmployeeData, skills: e.target.value })}
//                   />
//                 </div>
...
//                       <a href={editEmployeeData.resume} target="_blank" rel="noopener noreferrer">
//                         View Current Resume
//                       </a>
//                     </p>
//                   )}
...
//                       <a href={editEmployeeData.aadhaarCard} target="_blank" rel="noopener noreferrer">
...
//                       <a href={editEmployeeData.panCard} target="_blank" rel="noopener noreferrer">
...
//                       <a href={editEmployeeData.drivingLicense} target="_blank" rel="noopener noreferrer">
                      ...
                      {employee.skills.length > 20
                        ? (
                          <>
                            ...
                            <a href="#!" onClick={() => handleShow(employee.skills)} > View More</a>
                          </>
                        )
                        : employee.skills
                      }
