        ...
        <div className='manager-MonthlyAttendence'>
            ...
            <div className={`manager-MonthlyAttendence1 ${collapsed ? 'collapsed' : ''}`}>
                <div className="d-flex justify-content-center">
                    <h1 className='manager-monthlyattendance-heading'>Monthly Attendance for {new Date(currentDate.getFullYear(), parseInt(selectedMonth.split('-')[1], 10) - 1).toLocaleString('default', { month: 'long' })} {currentDate.getFullYear()}</h1>
                </div>
